...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        // Debugging: log `e.pathname` to check the exact format
        console.log("Pathname:", e.pathname);

        if (e.href.includes("/songs") ) {
            // Ensure folder name is trimmed and extracted correctly
            let folder = e.pathname.split("/").slice( -1)[0].trim();
            
            console.log("Extracted folder:", folder); // Debugging: log extracted folder
            ...
            if (albumData.ok) {
                ...
                // Display album card without folder name
...
async function main() {
    ...
    await getSongs(`songs/arijitsong`)
